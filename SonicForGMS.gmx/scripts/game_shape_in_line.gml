/// game_shape_in_line(shape, x1, y1, x2, y2)
/**
...
if (object_is_family(kind, Rectangle)) {
    ...
    result = line_in_quarter_ellipse(x1, y1, x2, y2, cx, cy, xrad, yrad);
    ...
    result = line_in_object(x1, y1, x2, y2, shape, true, true);
}
